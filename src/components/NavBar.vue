  ...
  <header class="header z-40">
    ...
    <nav class="nav">
      ...
      <div class="right" print:op0>
        ...
        <a href="https://x.com/Abhisek_217" target="_blank" title="Twitter" class="lt-md:hidden">
          <div i-ri-twitter-x-fill />
        </a>
        <a href="https://github.com/abhisek-ai" target="_blank" title="GitHub" class="lt-md:hidden">
